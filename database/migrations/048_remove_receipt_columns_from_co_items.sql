-- Migration 048: Remove receipt-related columns from change_order_items_list
...
ALTER TABLE public.change_order_items_list
  DROP CONSTRAINT IF EXISTS change_order_items_list_receipt_note_uuid_fkey;

-- Drop index
DROP INDEX IF EXISTS idx_co_items_receipt_note_uuid;
