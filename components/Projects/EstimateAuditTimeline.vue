...
const getActionIcon = (action: string): string => {
  const actionIcons: Record<string, string> = {
    ...
    unapproved: "i-heroicons-x-circle",
  }
...
const getActionDescription = (log: any): string => {
  ...
  const actionDescriptions: Record<string, string> = {
    created: 'Estimate was created',
    updated: 'Estimate was updated',
    marked_ready: 'Estimate was marked as ready',
    approved: 'Estimate was approved',
    unapproved: 'Estimate was unapproved',
  }
  
  return actionDescriptions[log.action] || 'Estimate was modified'
}
