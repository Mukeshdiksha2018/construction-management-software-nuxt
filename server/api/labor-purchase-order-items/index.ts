...
import { sanitizeLaborPurchaseOrderItem } from "./utils";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    if (method === "POST" || method === "PUT") {
      ...
      // Delete existing labor items for this purchase order
    ...
    if (method === "DELETE") {
      ...
      let builder = supabaseServer.from("labor_purchase_order_items_list").delete();
      if (uuid) {
    ...
    console.error("[labor-purchase-order-items] API error:", error);
